...
void ExternalCommandProcessor::ProcessHostCheckResult(double time, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Processing passive check result for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::ProcessServiceCheckResult(double time, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Processing passive check result for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::ScheduleHostCheck(double, const std::vector<String>& arguments)
{
	...
	if (planned_check > host->GetNextCheck()) {
		Log(LogNotice, "ExternalCommandProcessor", "Ignoring reschedule request for host '" +
		    arguments[0] + "' (next check is already sooner than requested check time)", host->IsLogVerbose());
		return;
	}

	Log(LogNotice, "ExternalCommandProcessor", "Rescheduling next check for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::ScheduleSvcCheck(double, const std::vector<String>& arguments)
{
	...
	if (planned_check > service->GetNextCheck()) {
		Log(LogNotice, "ExternalCommandProcessor", "Ignoring reschedule request for service '" +
		    arguments[1] + "' (next check is already sooner than requested check time)", service->IsLogVerbose());
		return;
	}

	Log(LogNotice, "ExternalCommandProcessor", "Rescheduling next check for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::EnableHostCheck(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Enabling active checks for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::DisableHostCheck(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Disabling active checks for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::EnableSvcCheck(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Enabling active checks for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::DisableSvcCheck(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Disabling active checks for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::ScheduleForcedHostSvcChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, host->GetServices()) {
		Log(LogNotice, "ExternalCommandProcessor", "Rescheduling next check for service '" + service->GetName() + "'", host->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::ScheduleHostSvcChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, host->GetServices()) {
		if (planned_check > service->GetNextCheck()) {
			Log(LogNotice, "ExternalCommandProcessor", "Ignoring reschedule request for service '" +
			    service->GetName() + "' (next check is already sooner than requested check time)", host->IsLogVerbose() || service->IsLogVerbose());
			continue;
		}
...
void ExternalCommandProcessor::EnableHostSvcChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, host->GetServices()) {
		Log(LogNotice, "ExternalCommandProcessor", "Enabling active checks for service '" + service->GetName() + "'", host->IsLogVerbose() || service->IsLogVerbose());
		service->SetEnableActiveChecks(true);
	}
}
...
void ExternalCommandProcessor::DisableHostSvcChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, host->GetServices()) {
		Log(LogNotice, "ExternalCommandProcessor", "Disabling active checks for service '" + service->GetName() + "'", host->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::AcknowledgeSvcProblem(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Setting acknowledgement for service '" + service->GetName() + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::AcknowledgeSvcProblemExpire(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Setting timed acknowledgement for service '" + service->GetName() + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::RemoveSvcAcknowledgement(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Removing acknowledgement for service '" + service->GetName() + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::AcknowledgeHostProblem(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Setting acknowledgement for host '" + host->GetName() + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::AcknowledgeHostProblemExpire(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Setting timed acknowledgement for host '" + host->GetName() + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::RemoveHostAcknowledgement(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Removing acknowledgement for host '" + host->GetName() + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::EnableHostgroupSvcChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		BOOST_FOREACH(const Service::Ptr& service, host->GetServices()) {
			Log(LogNotice, "ExternalCommandProcessor", "Enabling active checks for service '" + service->GetName() + "'", hg->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::DisableHostgroupSvcChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		BOOST_FOREACH(const Service::Ptr& service, host->GetServices()) {
			Log(LogNotice, "ExternalCommandProcessor", "Disabling active checks for service '" + service->GetName() + "'", hg->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::EnableServicegroupSvcChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Enabling active checks for service '" + service->GetName() + "'", sg->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::DisableServicegroupSvcChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Disabling active checks for service '" + service->GetName() + "'", sg->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::EnablePassiveHostChecks(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Enabling passive checks for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::DisablePassiveHostChecks(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Disabling passive checks for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::EnablePassiveSvcChecks(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Enabling passive checks for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::DisablePassiveSvcChecks(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Disabling passive checks for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::EnableServicegroupPassiveSvcChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Enabling passive checks for service '" + service->GetName() + "'", sg->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::DisableServicegroupPassiveSvcChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Disabling passive checks for service '" + service->GetName() + "'", sg->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::EnableHostgroupPassiveSvcChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		BOOST_FOREACH(const Service::Ptr& service, host->GetServices()) {
			Log(LogNotice, "ExternalCommandProcessor", "Enabling passive checks for service '" + service->GetName() + "'", hg->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::DisableHostgroupPassiveSvcChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		BOOST_FOREACH(const Service::Ptr& service, host->GetServices()) {
			Log(LogNotice, "ExternalCommandProcessor", "Disabling passive checks for service '" + service->GetName() + "'", hg->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::ScheduleSvcDowntime(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Creating downtime for service " + service->GetName(), service->IsLogVerbose());
...
void ExternalCommandProcessor::ScheduleHostDowntime(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Creating downtime for host " + host->GetName(), host->IsLogVerbose());
...
void ExternalCommandProcessor::ScheduleHostSvcDowntime(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, host->GetServices()) {
		Log(LogNotice, "ExternalCommandProcessor", "Creating downtime for service " + service->GetName(), host->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::ScheduleHostgroupHostDowntime(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Creating downtime for host " + host->GetName(), hg->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::ScheduleHostgroupSvcDowntime(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, services) {
		Log(LogNotice, "ExternalCommandProcessor", "Creating downtime for service " + service->GetName(), hg->IsLogVerbose() || service->IsLogVerbose());
		(void) service->AddDowntime(arguments[6], arguments[7],
		    Convert::ToDouble(arguments[1]), Convert::ToDouble(arguments[2]),
		    Convert::ToBool(arguments[3]), triggeredBy, Convert::ToDouble(arguments[5]));
	}
...
void ExternalCommandProcessor::ScheduleServicegroupHostDowntime(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hosts) {
		Log(LogNotice, "ExternalCommandProcessor", "Creating downtime for host " + host->GetName(), sg->IsLogVerbose() || host->IsLogVerbose());
		(void) host->AddDowntime(arguments[6], arguments[7],
		    Convert::ToDouble(arguments[1]), Convert::ToDouble(arguments[2]),
		    Convert::ToBool(arguments[3]), triggeredBy, Convert::ToDouble(arguments[5]));
	}
...
void ExternalCommandProcessor::ScheduleServicegroupSvcDowntime(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Creating downtime for service " + service->GetName(), sg->IsLogVerbose() || service->IsLogVerbose());
		(void) service->AddDowntime(arguments[6], arguments[7],
		    Convert::ToDouble(arguments[1]), Convert::ToDouble(arguments[2]),
		    Convert::ToBool(arguments[3]), triggeredBy, Convert::ToDouble(arguments[5]));
	}
...
void ExternalCommandProcessor::AddHostComment(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Creating comment for host " + host->GetName(), host->IsLogVerbose());
...
void ExternalCommandProcessor::AddSvcComment(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Creating comment for service " + service->GetName(), service->IsLogVerbose());
...
void ExternalCommandProcessor::DelAllHostComments(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Removing all comments for host " + host->GetName(), host->IsLogVerbose());
...
void ExternalCommandProcessor::DelAllSvcComments(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Removing all comments for service " + service->GetName(), service->IsLogVerbose());
...
void ExternalCommandProcessor::SendCustomHostNotification(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Sending custom notification for host " + host->GetName(), host->IsLogVerbose());
	if (options & 2) {
		ObjectLock olock(host);
...
void ExternalCommandProcessor::SendCustomSvcNotification(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Sending custom notification for service " + service->GetName(), service->IsLogVerbose());
...
void ExternalCommandProcessor::DelayHostNotification(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Delaying notifications for host '" + host->GetName() + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::DelaySvcNotification(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Delaying notifications for service " + service->GetName(), service->IsLogVerbose());
...
void ExternalCommandProcessor::EnableHostNotifications(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Enabling notifications for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::DisableHostNotifications(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Disabling notifications for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::EnableSvcNotifications(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Enabling notifications for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::DisableSvcNotifications(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Disabling notifications for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::DisableHostgroupHostChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Disabling active checks for host '" + host->GetName() + "'", hg->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::DisableHostgroupPassiveHostChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Disabling passive checks for host '" + host->GetName() + "'", hg->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::DisableServicegroupHostChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		...
		Log(LogNotice, "ExternalCommandProcessor", "Disabling active checks for host '" + host->GetName() + "'", sg->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::DisableServicegroupPassiveHostChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		...
		Log(LogNotice, "ExternalCommandProcessor", "Disabling passive checks for host '" + host->GetName() + "'", sg->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::EnableHostgroupHostChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Enabling active checks for host '" + host->GetName() + "'", hg->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::EnableHostgroupPassiveHostChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Enabling passive checks for host '" + host->GetName() + "'", hg->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::EnableServicegroupHostChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		...
		Log(LogNotice, "ExternalCommandProcessor", "Enabling active checks for host '" + host->GetName() + "'", sg->IsLogVerbose() || service->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::EnableServicegroupPassiveHostChecks(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		...
		Log(LogNotice, "ExternalCommandProcessor", "Enabling passive checks for host '" + host->GetName() + "'", sg->IsLogVerbose() || service->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::EnableHostFlapping(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Enabling flapping detection for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::DisableHostFlapping(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Disabling flapping detection for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::EnableSvcFlapping(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Enabling flapping detection for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::DisableSvcFlapping(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Disabling flapping detection for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeSvcModattr(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Updating modified attributes for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeHostModattr(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Updating modified attributes for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeUserModattr(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Updating modified attributes for user '" + arguments[0] + "'", user->IsLogVerbose());
...
{
	Log(LogNotice, "ExternalCommandProcessor", "Updating modified attributes for command '" + command->GetName() + "'", command->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeNormalSvcCheckInterval(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Updating check interval for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeNormalHostCheckInterval(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Updating check interval for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeRetrySvcCheckInterval(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Updating retry interval for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeRetryHostCheckInterval(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Updating retry interval for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::EnableHostEventHandler(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Enabling event handler for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::DisableHostEventHandler(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Disabling event handler for host '" + arguments[0] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::EnableSvcEventHandler(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Enabling event handler for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::DisableSvcEventHandler(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Disabling event handler for service '" + arguments[1] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeHostEventHandler(double, const std::vector<String>& arguments)
{
	...
	if (arguments[1].IsEmpty()) {
		...
		Log(LogNotice, "ExternalCommandProcessor", "Changing event handler for host '" + arguments[0] + "' to '" + arguments[1] + "'", host->IsLogVerbose() || command->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeSvcEventHandler(double, const std::vector<String>& arguments)
{
	...
	if (arguments[2].IsEmpty()) {
		...
		Log(LogNotice, "ExternalCommandProcessor", "Changing event handler for service '" + arguments[1] + "' to '" + arguments[2] + "'", service->IsLogVerbose() || command->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeHostCheckCommand(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Changing check command for host '" + arguments[0] + "' to '" + arguments[1] + "'", host->IsLogVerbose() || command->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeSvcCheckCommand(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Changing check command for service '" + arguments[1] + "' to '" + arguments[2] + "'", service->IsLogVerbose() || command->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeMaxHostCheckAttempts(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Changing max check attempts for host '" + arguments[0] + "' to '" + arguments[1] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeMaxSvcCheckAttempts(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Changing max check attempts for service '" + arguments[1] + "' to '" + arguments[2] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeHostCheckTimeperiod(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Changing check period for host '" + arguments[0] + "' to '" + arguments[1] + "'", host->IsLogVerbose() || tp->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeSvcCheckTimeperiod(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Changing check period for service '" + arguments[1] + "' to '" + arguments[2] + "'", service->IsLogVerbose() || tp->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeCustomHostVar(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Changing custom var '" + arguments[1] + "' for host '" + arguments[0] + "' to value '" + arguments[2] + "'", host->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeCustomSvcVar(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Changing custom var '" + arguments[2] + "' for service '" + arguments[1] + "' on host '" +
	    arguments[0] + "' to value '" + arguments[3] + "'", service->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeCustomUserVar(double, const std::vector<String>& arguments)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Changing custom var '" + arguments[1] + "' for user '" + arguments[0] + "' to value '" + arguments[2] + "'", user->IsLogVerbose());
...
void ExternalCommandProcessor::ChangeCustomCommandVarInternal(const Command::Ptr& command, const String& name, const Value& value)
{
	...
	Log(LogNotice, "ExternalCommandProcessor", "Changing custom var '" + name + "' for command '" + command->GetName() + "' to value '" + Convert::ToString(value) + "'", command->IsLogVerbose());
...
void ExternalCommandProcessor::EnableHostgroupHostNotifications(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Enabling notifications for host '" + host->GetName() + "'", hg->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::EnableHostgroupSvcNotifications(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		BOOST_FOREACH(const Service::Ptr& service, host->GetServices()) {
			Log(LogNotice, "ExternalCommandProcessor", "Enabling notifications for service '" + service->GetName() + "'", hg->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::DisableHostgroupHostNotifications(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Disabling notifications for host '" + host->GetName() + "'", hg->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::DisableHostgroupSvcNotifications(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Host::Ptr& host, hg->GetMembers()) {
		BOOST_FOREACH(const Service::Ptr& service, host->GetServices()) {
			Log(LogNotice, "ExternalCommandProcessor", "Disabling notifications for service '" + service->GetName() + "'", hg->IsLogVerbose() || host->IsLogVerbose());
...
void ExternalCommandProcessor::EnableServicegroupHostNotifications(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		...
		Log(LogNotice, "ExternalCommandProcessor", "Enabling notifications for host '" + host->GetName() + "'", sg->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::EnableServicegroupSvcNotifications(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Enabling notifications for service '" + service->GetName() + "'", sg->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::DisableServicegroupHostNotifications(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		...
		Log(LogNotice, "ExternalCommandProcessor", "Disabling notifications for host '" + host->GetName() + "'", sg->IsLogVerbose() || service->IsLogVerbose());
...
void ExternalCommandProcessor::DisableServicegroupSvcNotifications(double, const std::vector<String>& arguments)
{
	...
	BOOST_FOREACH(const Service::Ptr& service, sg->GetMembers()) {
		Log(LogNotice, "ExternalCommandProcessor", "Disabling notifications for service '" + service->GetName() + "'", sg->IsLogVerbose() || service->IsLogVerbose());
